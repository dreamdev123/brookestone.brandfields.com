      ...
      <div class="row">
        <div class="offset-lg-3 col-lg-9 col-md-12 col-sm-12 col-12">
          <div class="row">
            ...
            <div class="col-lg-3">
              <button class="btn rounded-pill shadow-none text-white advSearch" style="background-color: #3598dc; border: none;"><span class="fa fa-binoculars"></span> Advanced </button>
            </div>
          </div>
        ...
        <div class="memberNav col-md-3 col-sm-3 pr-0">
          <div class="navCard" data-user="{{ $user->id }}">
            <div class="headerDetails">
              <img src="{{ asset('images') }}{{ $user->profile->gender == 'F' ? '/femaleUser.jpg' : '/maleUser.jpg'}}">
                        ...
                        <div class="profileSectionBody toggleBody" style="display: block">
                                ...
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                      <div type="button" class="btn green ladda-button usernameSave" data-style="contract" data-dismiss="modal">
                          ...
                          <form method="POST" action="{{route('admin.members.profileSponsorId')}}" class="form ajaxSave" id="sponsorIdForm{{$user->id}}">
                            ...
                            <fieldset>
                              ...
                              <div class="eachField row">
                                <div class="col-md-5">
                                  <button type="button" class="btn btn-success" data-toggle="modal" data-target="#sponsorIdSaveModal_{{ $user->id }}" style="min-width: 100px"> Save </button>
                                </div>
                              </div>
                              ...
                              <div class="modal fade" id="sponsorIdSaveModal_{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="sponsorIdSaveModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                      <div type="button" class="btn green ladda-button sponsorIdSave" data-style="contract" data-dismiss="modal">
                                        <span class="ladda-label"> Save </span><span class="ladda-spinner"></span>
                                      </div>
                                      <button type="button" class="btn default" data-dismiss="modal">Close
                                      </button>
                        ...
                        <form method="POST" action="{{route('admin.members.profileProfile')}}" class="form ajaxSave" id="profileForm{{$user->id}}">
                          ...
                          <div class="profileSectionBody toggleBody" style="display: block">
                            <div class="eachField row">
                              ...
                              <div class="col-md-7">
                                <input type="text" class="form-control" placeholder="First Name" name="first_name" id="first_name" value="{{ $user->profile->first_name }}">
                              </div>
                            </div>
                            <div class="eachField row">
                              <div class="col-md-5">
                              ...
                              <div class="col-md-7">
                                <input type="text" class="form-control" placeholder="Last Name" name="last_name" id="last_name" value="{{ $user->profile->last_name }}">
                              </div>
                            </div>
                            <div class="eachField row">
                              <div class="col-md-5">
                              ...
                              <div class="col-md-7">
                                <input type="text" class="datePicker date_of_birth" data-date-format="yyyy-mm-dd" name="date_of_birth" value="{{ $user->profile->birthday }}">
                              </div>
                            </div>
                            <div class="eachField row">
                              <div class="col-md-5">
                              ...
                              <div class="col-md-7">
                                <input type="text" class="form-control" placeholder="Passport Number" name="passport_id" id="passport_id" value="{{ $user->profile->passport_id }}">
                              </div>
                            </div>
                            <div class="eachField row">
                              <div class="col-md-5">
                              ...
                              <div class="col-md-7 mt-radio-inline" style="padding: 0px 10px;">
                                <label class="mt-radio d-inline-flex ml-2 mr-5 cursor-pointer">
                                  <input type="radio" name="gender" id="optionsRadios25" class="mr-1" value="M" @if($user->profile->gender == 'M') checked @endif> Male
                                  <span></span>
                                </label>
                                <label class="mt-radio d-inline-flex cursor-pointer">
                                  <input type="radio" name="gender" id="optionsRadios26" class="mr-1" value="F" @if($user->profile->gender == 'F') checked @endif> Female
                                  <span></span>
                                </label>
                              </div>
                            </div>
                            ...
                            <div class="eachField row">
                              ...
                              <div class="col-md-7">
                                <input type="text" class="datePicker date_of_passport_issuance" data-date-format="yyyy-mm-dd" placeholder=" Date of Passport Issuance" name="date_of_passport_issuance" value="{{ $user->profile->passport_issuance_date }}">
                              </div>
                            </div>
                            <div class="eachField row">
                              <div class="col-md-5">
                              ...
                              <div class="col-md-7">
                                <input type="text" class="datePicker date_of_passport_expiration" data-date-format="yyyy-mm-dd" placeholder="Passport Expiration Date" name="date_of_passport_expiration" value="{{ $user->profile->passport_expirition_date }}">
                              </div>
                            </div>
                            <div class="eachField row">
                              <div class="col-md-5">
                            ...
                            <div class="eachField row">
                              ...
                              <div class="col-md-7">
                                <input type="text" class="form-control" placeholder="Phone" name="mobile_number" id="mobile_number" value="{{ $user->phone }}">
                              </div>
                            </div>
                            <div class="eachField row">
                              <div class="col-md-5">
                              ...
                              <div class="col-md-7">
                                <input type="text" class="form-control" placeholder="Street Name" name="street_name" id="street_name" value="{{ $user->profile->street_name }}">
                              </div>
                            </div>
                            <div class="eachField row">
                              <div class="col-md-5">
                              ...
                              <div class="col-md-7">
                                <input type="text" class="form-control" placeholder="House Number" name="house_number" id="house_number" value="{{ $user->profile->house_number }}">
                              </div>
                            </div>
                            <div class="eachField row">
                              <div class="col-md-5">
                              ...
                              <div class="col-md-7">
                                <input type="text" class="form-control" placeholder="Postal Code" name="postal_code" id="postal_code" value="{{ $user->profile->postal_code }}">
                              </div>
                            </div>
                            <div class="eachField row">
                              <div class="col-md-5">
                            ...
                            <div class="eachField row">
                              ...
                              <div class="col-md-7">
                                <input type="text" class="form-control" placeholder="City" name="city" id="city" value="{{ $user->profile->city }}">
                              </div>
                            </div>
                            <div class="eachField row">
                              <div class="col-md-5">
                            ...
                            <div class="modal fade" id="profileSaveModal_{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="profileSaveModalLabel" aria-hidden="true">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    <button type="button" class="btn green ladda-button profileSave" data-style="contract" data-dismiss="modal"><span class="ladda-label"> Save </span><span class="ladda-spinner"></span></button>
                      ...
                      <div class="profileSection mfkToggleWrap">
                        <form method="POST" action="{{route('admin.members.profilePassword')}}" class="form ajaxSave" id="passwordForm{{$user->id}}">
                          ...
                          <div class="profileSectionBody toggleBody" style="display: block">
                            ...
                            <div class="eachField row">
                              <div class="col-md-5">
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#passwordSaveModal_{{ $user->id }}" style="min-width: 100px"> Save </button>
                              </div>
                            </div>
        ...
        $.ajax({
          ...
          success:function(res){
            ...
            if (res.status) {
              ...
              for(var resIndex = 0; resIndex < res.users.length; resIndex++) {
                html += '<li class="eachItem" data-id="' + res.users[resIndex].id +'"><i class="fa fa-user"></i> ' + res.users[resIndex].username + '</li>';
              }
              html += '</ul';
        ...
        success:function(res){
          if (res.status) {
            ...
            output += '<div class="col-md-3 setHolder">\n' +
                '                <div class="resultSet" data-id="' + res.users[0].id + '">\n' +
                '                    <div class="headerData">\n' +
                '                        <div class="profilePic">\n' +
                '                            <img src="{{ asset('images') }}' + ((res.profiles[0].gender == 'F')?'/femaleUser.jpg':'/maleUser.jpg') + '">\n' +
                '                        </div>\n' +
                '                        <div class="data">\n' +
                '                            <div class="username">' + res.users[0].username + '</div>\n' +
                '                        </div>\n' +
                '                    </div>\n' +
                '                    <div class="bodyData">\n' +
                '                        <div class="eachData">\n' +
                '                           <label>Full Name</label>\n' +
                '                            <span class="value">' + res.profiles[0].first_name + ' ' + res.profiles[0].last_name + '</span>\n' +
                '                        </div>\n' +
                '                        <div class="eachData">\n' +
                '                          <label>Email</label>\n' +
                '                            <span class="value">' + res.users[0].email + '</span>\n' +
                '                        </div>\n' +
                '                        <div class="eachData">\n' +
                '                            <label>Phone</label>\n' +
                '                            <span class="value">' + res.users[0].phone + '</span>\n' +
                '                        </div>\n' +
                '                    </div>\n' +
                '                </div>\n' +
                '            </div></div>';
            ...
            $('.advSearchResult .resultSummary').find('h3 span').text(res.users.length);
